...
public class QoiTestsStreamCompare
{
    ...
    [Fact]
    public void RgbEncoding_QOI_OP_RUN()
    {
        byte[] imageBytes = [
    ...
    [Fact]
    public void RgbEncoding_ReturnBytebyByte_QOI_OP_RUN()
    {
        byte[] imageBytes = [
            12 ,34, 65, 12 ,34, 65, 12 ,34, 65,
            12 ,34, 65, 12 ,34, 65, 12 ,34, 65
    ...
    [Fact]
    [ExcludeFromCodeCoverage(Justification = "Error with Assert.Throws")]
    public void RgbEncoding_WrongInputStreamLength()
    {
        byte[] imageBytes = [
            12 ,34, 65, 112 ,34, 65,
            12 ,34, 65, 13 ,34, 65
...
public static class QoiEncoderStreamExtensions
{
    /// <summary>
